            ...
            <div class="col-sm-12">
                <c:forEach var="p" items="${posts}">
                    <form action="goToReply.do" method="Post"
                        style="background-color: #E9ECEF; padding: 10px; margin: 10px; border-radius: 5px;">
                        <div class="form-group">
                            ...
                            <div class="jumbotron jumbotron-fluid"
                                style="background-color: white; border-raidus: 5px;">
                                <div class="container"
                                    style="padding: 5px;">
                            ...
                            <c:forEach var="reply" items="${p.replies}">
                                ...
                                <p
                                    style="background-color: #007BFF; border-radius: 5px; padding: 5px; width: auto; height: 50px; color: white;">${reply.username}:
                                    ${reply.message}<br>
                                </p>
