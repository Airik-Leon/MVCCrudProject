                ...
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Projects after
                            thoughts</h4>
                        <p class="card-text">
                            My thoughts on the projects I have worked on and 
                            how I feel about various software engineering topics. 
                        </p>
            ...
            <div class="col-sm">
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        I first started college wanting to do journalism. Somehow I ended studying Software Engineering. 
                        </p>
                        <a href="#" class="btn btn-primary">Go
                            </a>
                    </div>
            ...
            <div class="col-sm" style="height:500px">
                <div class="card" style="width: 20rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">
                        My work as a photographer. A hobby I don't practice enough of
                        but I will always enjoy the landscapes when I can. 
                        </p>
                        <a href="#" class="btn btn-primary">Go
                            </a>
                    </div>
